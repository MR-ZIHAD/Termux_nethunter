...
print_banner() {
    ...
    echo "##         CREATED BY  ZIHAD HOSSAIN RAFI     ##"
    echo  "################### NetHunter ####################"
}
...
author_info() {
    ...
    echo "        Creator Info     "
    echo 
    echo "Name: MD ZAHIDUL ISLAM (MR-ZIHAD)\n"
    echo
    echo "Github: https://github.com/MR-ZIHAD\n"
    echo
    echo "YouTube: TECHNICAL ZIHAD"
    echo
    echo "TEAM: B.P SYBER SECURITY AGENCY"
    echo ""
    echo "FaceBook: MD ZAHIDUL ISLAM"
    echo 
